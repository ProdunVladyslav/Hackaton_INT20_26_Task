...
namespace Application.Migrations
{
    ...
    [Migration("20260702140827_AddLeadChannels")]
    partial class AddLeadChannels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Model.Survey.LeadChannel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("LeadChannels", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Model.User.Lead", b =>
                {
                    ...
                    b.HasIndex("FlowId", "LeadChannelId");
            ...
            modelBuilder.Entity("Domain.Model.User.Lead", b =>
                {
                    ...
                    b.HasOne("Domain.Model.Survey.LeadChannel", null)
                        .WithMany()
